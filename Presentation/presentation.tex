...
% \source{medivizor.com} 
	...
	\subfloat[]{\includegraphics[width=4cm]{pics/seq2.png}}
	\subfloat[]{\includegraphics[width=3.5cm]{pics/illumina.jpg}} 		 
...
\begin{itemize}
	...
	\item \emph{Post-mortem} molecule damage: deamination (substitutions of C$\to$T).
...
\begin{frame}{Sequencing Ancient DNA}

	\begin{figure}
	
		\subfloat[]{\includegraphics[width=9cm]{pics/aDNA_characteristics_New.pdf}}
%		\subfloat[]{\includegraphics[width=7cm]{pics/aDNA_characteristics.pdf}}
	%	\subfloat[]{\includegraphics[width=.689in]{pics/skullss.jpg}} \hspace*{2cm}
...
\vskip .5cm 
		...
		\hspace{45pt} $S_{2}:$\hspace{25pt} \textbf{\texttt{\textcolor{candyapplered}{-}}CG\textcolor{candyapplered}{--}AT\textcolor{candyapplered}{-}G\textcolor{candyapplered}{-}AC} \\
\end{itemize}
